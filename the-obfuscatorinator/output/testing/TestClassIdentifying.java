public class TestClassIdentifying<G,HK,L> {
    ...
    class SecondInnerClass {
        ...
        public <V, M> ArrayList<Map<String, String>> test_template_method_detection123(double gll, Integer forty_five, String test_template_method_detection123){
            return null;
        }
    }
    ...
    public static <V, M> String staticMethodAlso(double gll, Integer forty_five, String test_template_method_detection123){
        return "static method";
    }
}
